...
const init = () => {
  vditor.value = new Vditor(editorRef.value, {
    // i18n: '', // 国际化, 见ITips
    height: props.height,
    minHeight: props.minHeight, // 最小高度
    width: props.width, // 宽度
    theme: props.theme, // dark or classic
    mode: props.mode, // wysiwyg, ir, sv
    lang: 'zh_CN', // en_US, fr_FR, ja_JP, ko_KR, ru_RU, sv_SE, zh_CN, zh_TW
    tab: '\t',
    typewriterMode: true, // 是否启用打字机模式
    value: props.modelValue, // 初始化值
    placeholder: props.placeholder,
    // cdn: '', // 自建cdn地址
    debugger: false, // 是否显示日志
    // undoDelay: 1, // 历史记录间隔
    icon: 'material', // ant or material
    // toolbar: [
    //   // 自定义工具栏按钮
    //   {
    //     hotkey: '⇧⌘S', // 快捷键
    ...
    image: {
      // 图片预览处理 https://ld246.com/article/1549638745630#options-image
